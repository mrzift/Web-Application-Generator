package com.jhipster.timothy.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.jhipster.timothy.service.EmailAlreadyUsedException ||
            ex instanceof com.jhipster.timothy.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.jhipster.timothy.service.InvalidPasswordException
